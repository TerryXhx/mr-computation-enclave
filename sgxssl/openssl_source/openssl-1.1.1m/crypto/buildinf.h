...
#define DATE "built on: Sun Jun 19 10:08:59 2022 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','c','k',' ','-','W','a','l','l',' ','-','O','3',' ','-','i',
    'n','c','l','u','d','e','/','h','o','m','e','/','n','s','e','c',
    '-','s','g','x','/','s','g','x','-','p','l','a','y','g','r','o',
    'u','n','d','/','m','r','-','c','o','m','p','u','t','a','t','i',
    'o','n','-','e','n','c','l','a','v','e','/','s','g','x','s','s',
